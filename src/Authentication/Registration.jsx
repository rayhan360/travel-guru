            ...
            <div className="flex justify-center my-10">
                <div className="relative flex flex-col rounded-xl bg-transparent bg-clip-border text-gray-700 shadow-none">
                    ...
                    <form onSubmit={handleRegister} className="mt-8 mb-2 w-80 max-w-screen-lg sm:w-96">
                        ...
                        <input
                            className="mt-6 block w-full select-none rounded-lg bg-[#F9A51A] py-3 px-6 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-[#F9A51A]/20 transition-all hover:shadow-lg hover:shadow-[#F9A51A]/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                            type="submit"
                    ...
                    <p className="mt-4 block text-center font-sans text-base font-normal leading-relaxed text-gray-700 antialiased">
                        ...
                        <Link to="/login"
                            className="font-medium text-[#F9A51A] transition-colors hover:text-blue-700"
                            href="#"
                        >
                            Log In
                        </Link>
